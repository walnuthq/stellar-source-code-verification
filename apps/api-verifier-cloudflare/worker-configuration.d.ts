/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b000edfdf7e5907944ac1c786e81cf0a)
// Runtime types generated with workerd@1.20260623.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	PORT: "8080";
	ALLOWED_ORIGINS: "*";
	VERIFIER: DurableObjectNamespace<import("./src/server").Verifier>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "Verifier";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PORT" | "ALLOWED_ORIGINS">> {}
}
